...
class Services_Paymill_PaymentProcessor
{
    ...
    /**
     * if true an preauthorized will be created instead of a transaction
     *
     * @param boolean $createPreauth
     */
    public function setCreatePreauth($createPreauth)
    {
        $this->_createPreauth = $createPreauth;
    }
